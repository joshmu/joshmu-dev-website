...
export const setupTests = (() => {
  ...
  jest.mock("framer-motion", () => {
    ...
    const motion = {
      div: jest.fn(({ children, ...props }) => <div {...attrsToLowerCase(props)}>{children}</div>),
      span: jest.fn(({ children, ...props }) => (
        <span {...attrsToLowerCase(props)}>{children}</span>
      )),
      svg: jest.fn(({ children, ...props }) => <svg {...attrsToLowerCase(props)}>{children}</svg>),
      ...
      ul: jest.fn(({ children, ...props }) => <ul {...attrsToLowerCase(props)}>{children}</ul>),
    };
